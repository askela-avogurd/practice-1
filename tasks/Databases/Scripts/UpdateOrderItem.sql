...
SELECT @LenaOrderId = o.Id
FROM [Order] o
JOIN Customer c ON o.CustomerId = c.Id
WHERE c.Email = 'vernik_@inbox.ru';
...
SELECT @AnnaOrderId = o.Id
FROM [Order] o
JOIN Customer c ON o.CustomerId = c.Id
WHERE c.Email = 'annasan@mail.ru';
...
UPDATE OrderItem
SET OrderId = @LenaOrderId
WHERE YarnId = 
	(SELECT Id FROM Yarn WHERE Name = 'Alize Lanagold Fine')
	AND OrderId = @AnnaOrderId
;
