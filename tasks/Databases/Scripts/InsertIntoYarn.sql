...
INSERT INTO Yarn(Name, PricePer100g, StockQuantity, IsInStock, BrandId, CategoryId)
VALUES
	(
		  'Super Acrylic'
		, 350.00
		...
		, ISNULL((
			...
			FROM
				Brand
			WHERE
				Name LIKE '%Lana Grossa%'), 0), (ISNULL((SELECT TOP 1 Id FROM Category WHERE TypeName LIKE '%Acrylic%'), 0))),
